...
export const METHOD_COLS = [
  ...
  { key: "cheque", label: "เช็ค" }, // แทนคอลัมน์ไฟแนนซ์ (user 2026-09-24) — ยอด + เลขที่เช็คจาก breakdown วิธี "เช็ค" (split.cheque_nos)
...
export function methodKey(name) {
  ...
  if (n.includes("ไฟแนน")) return "other"; // คอลัมน์ไฟแนนซ์ถูกถอดออก (2026-09-24) — ยอดไฟแนนซ์ (ถ้ามี) ไปรวมใน other
  return "other";
}

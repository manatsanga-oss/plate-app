...
function Sidebar({ activeMenu, onChange, currentUser, onLogout, canAccess }) {
  const salesPages = ["moto", "booking", "pricecheck", "pricequote", "stockcheck", "motostock", "mototransfer", "customer", "deliveryfee", "pricemarkup", "receiptqr", "receiptissue", "retailsale", "bookingdeposit", "redplaterefund", "redplatedeposit"];
  ...
  return (
    <aside className="sidebar">
      ...
      <MenuGroup title="Sales" pages={salesPages} activeMenu={activeMenu} onChange={onChange} canAccess={canAccess}>
        ...
        <MenuSubGroup title="ขายรถ" pages={["retailsale", "bookingdeposit", "redplatedeposit", "redplaterefund", "salewizard", "usedmoto", "salemoneyreport"]} activeMenu={activeMenu} canAccess={canAccess}>

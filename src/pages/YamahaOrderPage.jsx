...
const CLOSED_STATUSES = ["ปิดงานซ่อม", "ปิดการขาย"];
...
export default function YamahaOrderPage({ currentUser }) {
  ...
  async function viewDetail(order) {
    try {
      ...
      setShowDetail({ ...order, items: itemsWithStock, boItems, b2bItems: null, unmatched: null, missingInB2b: null, allMatched: null });
  ...
  return (
    <div className="page-container">
      ...
      <div style={{ display: "flex", gap: 8, marginBottom: 12, flexWrap: "wrap" }}>
        {["all", "รอดำเนินการ", "สั่งซื้อแล้ว", "มาครบ", "มาไม่ครบ", "อะไหล่ค้างส่ง", "เปิดงาน", "ปิดงานซ่อม", "ตีราคาซ่อม"].map(s => {

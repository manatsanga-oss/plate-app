...
// คำนำหน้าอังกฤษสำหรับลูกค้าต่างชาติ (MR./MRS./MS./MISS) — user 2026-09-09
const TITLE_OPTS = ["นาย", "นาง", "นางสาว", "เด็กชาย", "เด็กหญิง", "MR.", "MRS.", "MS.", "MISS", "บมจ.", "บจก.", "หจก.", "บริษัท", "ห้าง", "อื่นๆ"];
      ...
      <div style={box} onClick={(e) => e.stopPropagation()}>
        ...
        <div style={section}>
          ...
          <div style={grid2}>
            ...
            <Field label="วัน/เดือน/ปี เกิด"><BirthDateField form={form} setForm={setForm} inp={inp} /></Field>

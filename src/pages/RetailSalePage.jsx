              ...
              <CardBody>
                  ...
                  {editable ? (
                    ...
                    <>
                      ...
                      {(() => {
                        ...
                        const disabled = lineSending === "sale" || sent || pending;
                        return (
                          <button style={{ ...btn(sent ? "#94a3b8" : "#06C755"), cursor: disabled ? "not-allowed" : "pointer" }} disabled={disabled} onClick={sendSaleLine} title={sent ? "ส่งแล้ว — ปิดแล้วเปิดใหม่เพื่อส่งอีกครั้ง" : ""}>
                            {lineSending === "sale" ? "ส่ง…" : pending ? "⏰ กำลังจะส่ง…" : sent ? "✅ ส่ง LINE แล้ว" : "📤 ส่งใบขาย LINE"}
                          </button>
                        );
                      })()}
                ...
                {!editable && sale?.sale_no && (
                  <div style={{ marginTop: 10, padding: "10px 14px", background: "#eff6ff", border: "1px solid #bfdbfe", borderRadius: 10, display: "flex", gap: 10, alignItems: "center", justifyContent: "center", flexWrap: "wrap" }}>
                    <span style={{ fontSize: 13, fontWeight: 600, color: "#1e40af" }}>📄 เอกสารประกัน COSMOS (ใบสมัครฮอนด้าพลัส):</span>
                    ...
                    {(() => {
                      ...
                      return (
                        <button
                          ...
                          disabled={disabled}
                          onClick={() => uploadDoc(cosmosFile, "cosmos", "ใบสมัครฮอนด้าพลัส (COSMOS)", setCosmosFile, setCosmosUploading)}
                          title={sent ? "ส่งแล้ว — ปิดแล้วเปิดใหม่เพื่อส่งอีกครั้ง" : ""}
                        >
                          {cosmosUploading ? "กำลังส่ง…" : pending ? "⏰ กำลังจะส่ง…" : sent ? "✅ ส่ง COSMOS แล้ว" : "⬆️ อัปโหลด + แจ้ง COSMOS (LINE)"}
                        </button>
                      );
                    })()}
                  </div>
                ...
                {!editable && sale?.sale_no && (
                  <div style={{ marginTop: 10, padding: "10px 14px", background: "#f0fdfa", border: "1px solid #99f6e4", borderRadius: 10, display: "flex", gap: 10, alignItems: "center", justifyContent: "center", flexWrap: "wrap" }}>
                    <span style={{ fontSize: 13, fontWeight: 600, color: "#0f766e" }}>📄 ส่งเอกสารให้ลูกค้า (PDF):</span>
                    ...
                    {(() => {
                      ...
                      return (
                        <button
                          ...
                          disabled={disabled}
                          onClick={() => uploadDoc(docFile, "doc", "เอกสาร", setDocFile, setDocUploading)}
                          title={sent ? "ส่งแล้ว — ปิดแล้วเปิดใหม่เพื่อส่งอีกครั้ง" : ""}
                        >
                          {docUploading ? "กำลังส่ง…" : pending ? "⏰ กำลังจะส่ง…" : sent ? "✅ ส่งเอกสารแล้ว" : "⬆️ อัปโหลด + ส่งเอกสาร (LINE)"}
                        </button>
                      );
                    })()}
                  </div>

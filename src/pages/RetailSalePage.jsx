...
export default function RetailSalePage({ currentUser }) {
  ...
  const effectiveAdvance = isFinance(form.finance_type)
    ...
    : 0;
  const totalPaymentEff = (calc.totalPayment || 0) + (Number(effectiveAdvance) || 0);
            ...
            <Card>
              ...
              <CardBody>
                ...
                <Grid>
                  ...
                  <Field label="รวมยอดชำระ" unit value={<MoneyBox>{baht(editable ? totalPaymentEff : sale?.total_payment)}</MoneyBox>} />
                  <div />
                </Grid>
